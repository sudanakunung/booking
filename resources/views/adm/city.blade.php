            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ url('/dashboard/city/add') }}"> {{ csrf_field() }}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="city_name">City</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="city_name" name="city_name" onkeyup="createslug()" class="form-control col-md-7 col-xs-12" placeholder="e.g. Kitchen">
