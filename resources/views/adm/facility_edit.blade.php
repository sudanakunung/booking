            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ url('/dashboard/facility/edit/save/'.$edit->id) }}"> {{ csrf_field() }}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="facility_name">Facility</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="facility_name" name="facility_name" class="form-control col-md-7 col-xs-12" placeholder="e.g. Kitchen" value="{{ $edit->facility_name }}">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-6 col-xs-6">
                          <a href="{{ url('/dashboard/facility') }}" class="btn btn-danger"><i class="fa fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
